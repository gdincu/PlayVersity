    ...
    <div class="container input-group input-group-sm">
            <a class="navbar-brand js-scroll-trigger" href="index.php?page=user" style="color: #E8E8E8"><img src="./images/playversity_logo_6.png" class="w-50 h-50" alt="logo PlayVersity" /></a>
        </div>
